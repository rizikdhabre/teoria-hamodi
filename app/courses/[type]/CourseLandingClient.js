...
const COURSE_LANDING_HEBREW_SOURCES = [
  'קישור',
  'תיאור',
  'תור לקביעת תיאוריה',
  'תשלום רשיונות ים',
...
export default function CourseLandingClient({ type, isSeaCourse }) {
  const t = useTranslationStrings(COURSE_LANDING_HEBREW_SOURCES);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900">
      <div className="bg-gray-200 dark:bg-gray-800 p-10 rounded-2xl shadow-xl w-full max-w-md text-center">
        ...
        <div className="mb-6">
          <table className="w-full text-sm text-gray-900 dark:text-gray-200 border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden">
            <thead className="bg-gray-300 dark:bg-gray-700">
              <tr>
                <th className="p-2 text-right">{t('קישור')}</th>
                <th className="p-2 text-right">{t('תיאור')}</th>
              </tr>
            </thead>
            <tbody className="bg-gray-200 dark:bg-gray-800">
              {!isSeaCourse && (
                <tr className="border-t border-gray-300 dark:border-gray-700">
                  ...
                  <td className="p-2">{t('תור לקביעת תיאוריה')}</td>
                </tr>
              )}
              ...
              {isSeaCourse && (
                <>
                  <tr className="border-t border-gray-300 dark:border-gray-700">
                    ...
                    <td className="p-2">{t('תשלום אגרות ורשיונות')}</td>
                  </tr>
                  ...
                  <tr className="border-t border-gray-300 dark:border-gray-700">
                    <td className="p-2">
                      <a
                        ...
                        className="text-blue-400 hover:underline"
                      >
                        {t('קביעת תור לרשיונות ים')}
                      </a>
                    </td>
                    <td className="p-2">{t('זימון תור למבחן / רישיון')}</td>
                  </tr>
                </>
              )}
            </tbody>
        ...
        <p className="text-gray-900 dark:text-gray-100 mb-8 font-bold">
          {t('תבחר איך אתה רוצה ללמוד את הקורס')}
        </p>
