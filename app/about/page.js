...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background bg-gray-900 text-gray-200">
      {/* Hero */}
      <section className="py-20 bg-linear-to-b from-card to-background dark:from-zinc-900 dark:to-zinc-950">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          <div className="text-center md:text-right">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              <span className="text-primary">תיאוריה חמודי</span>
            </h1>
            <p className="text-xl text-muted-foreground dark:text-zinc-400 mb-6">
              בית ספר מקצועי ללימודי תיאוריה ונהיגה
            </p>
            <p className="text-lg text-muted-foreground dark:text-zinc-300 leading-relaxed">
              אנו מתמחים בהכנה מקיפה למבחני התיאוריה והנהיגה,
              תוך ליווי אישי, שיטות לימוד מתקדמות
              וניסיון מוכח בהובלת תלמידים להצלחה.
            </p>
          </div>
      ...
      {/* Stats */}
      <section className="py-12 border-y bg-card dark:bg-zinc-900 dark:border-zinc-800">
        <div className="container mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {stats.map((stat, i) => (
            <div
              key={i}
              className="p-6 rounded-xl bg-secondary/50 border dark:bg-zinc-800 dark:border-zinc-700"
            >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground dark:text-zinc-300 mb-4 text-lg leading-relaxed">
              תיאוריה חמודי הוא מוסד לימוד מוביל בתחום התיאוריה והנהיגה בישראל,
              עם התמחות בהכנה לכל סוגי הרישיונות — מהפרטי ועד המקצועי.
            </p>
            <p className="text-muted-foreground dark:text-zinc-300 mb-6 text-lg leading-relaxed">
              אנו מאמינים בשילוב בין מקצועיות, יחס אישי ולמידה חכמה,
              המאפשרים לכל תלמיד להגיע מוכן, בטוח וממוקד למבחן.
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-6 border rounded-xl bg-card dark:bg-zinc-900 dark:border-zinc-800">
      ...
      {/* Licenses */}
      <section className="py-20 bg-card dark:bg-zinc-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {licenseTypes.map((item, i) => (
              <div
                key={i}
                className="p-6 text-center rounded-xl bg-secondary/50 border dark:bg-zinc-800 dark:border-zinc-700 hover:scale-105 transition"
              >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          ...
          <div className="p-10 rounded-2xl bg-card border shadow dark:bg-zinc-900 dark:border-zinc-800">
            <a
